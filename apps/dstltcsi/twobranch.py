...
class Pipeline:
    ...
    def _create_source_elements(self):
        ...
        # branch1_queue = Gst.ElementFactory.make("queue", "branch1_queue")
        # branch2_queue = Gst.ElementFactory.make("queue", "branch2_queue")

        self.pipeline.add(source)
        self.pipeline.add(nvvidconv_src)
        self.pipeline.add(caps_nvvidconv_src)
        # self.pipeline.add(tee)
        # self.pipeline.add(branch1_queue)
        # self.pipeline.add(branch2_queue)
