...
class InferTrackPipeline:
    ...
    def _create_middle_elements(self):
        ...
        nvosd.set_property('display-clock',
                           1)  # here: https://docs.nvidia.com/metropolis/deepstream/dev-guide/text/DS_plugin_gst-nvdsosd.html
        ...
        return streammux, pgie, tracker, nvvidconv, nvosd
